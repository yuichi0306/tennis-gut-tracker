        ...
        {sortedSessions.length === 0 ? (
          ...
          <ul className="space-y-2">
            {filteredSessions.map((s) => (
              <li key={s.id} className="rounded-xl border border-gray-200 dark:border-slate-700 bg-white dark:bg-slate-800 shadow-sm p-3 text-sm">
                <div className="flex items-start justify-between gap-2">
                  ...
                  <div className="flex shrink-0 gap-2">
                    <button onClick={() => startEdit(s)} className="text-emerald-700 dark:text-emerald-400 hover:underline">
                      編集
                    </button>
                    <button onClick={() => deleteSession(s.id)} className="text-red-600 dark:text-red-400 hover:underline">
                      削除
                    </button>
                  </div>
                </div>
